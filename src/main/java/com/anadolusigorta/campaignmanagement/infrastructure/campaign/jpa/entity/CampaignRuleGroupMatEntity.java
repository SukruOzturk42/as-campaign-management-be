...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "campaign_rule_group_mat_group")
public class CampaignRuleGroupMatEntity extends AbstractEntity {
	...
	@OneToMany(mappedBy = "matGroup",cascade = CascadeType.ALL,fetch = FetchType.EAGER)
