...
@NoArgsConstructor
@AllArgsConstructor
public class ExcelExportOfDiscountCodeResponse {

    private List<com.anadolusigorta.campaignmanagement.domain.campaigncode.model.DiscountCode> codes;
    ...
    private ExcelFileGenerationOutput getExcelFileGenerationOutput(List<com.anadolusigorta.campaignmanagement.domain.campaigncode.model.DiscountCode> codes, String fileName) throws IOException {
        byte[] excelContent = generateExcel(codes);
        if(excelContent.length != 0) {
            String tempDirectoryPath = FileUtils.getTempDirectoryPath();
            var file = new File(tempDirectoryPath + "campuscodes" + ".xlsx");
    ...
    private static byte[] generateExcel(List<com.anadolusigorta.campaignmanagement.domain.campaigncode.model.DiscountCode> codes) throws IOException {
        Workbook workbook;
        try {
