...
@NoArgsConstructor
@AllArgsConstructor
public class DiscountCodeTemplateExcelResponse {
    ...
    private ExcelFileGenerationOutput getExcelFileGenerationOutput() throws IOException {
        ...
        if(excelContent.length != 0) {
            ...
            var file = new File(tempDirectoryPath + "template-discount-code" + ".xlsx");
