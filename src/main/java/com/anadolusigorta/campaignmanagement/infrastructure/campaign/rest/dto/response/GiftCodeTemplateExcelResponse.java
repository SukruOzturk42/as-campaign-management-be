...
@NoArgsConstructor
@AllArgsConstructor
public class GiftCodeTemplateExcelResponse {
	...
	private static byte[] generateExcel() throws IOException {
		...
		cell.setCellValue("Çek Kod");
		cell = row.createCell(1);
		cell.setCellValue("SORT LINK");
		Row rowExample = sheet.createRow(1);
		Cell cellExample = rowExample.createCell(0);
		cellExample.setCellValue("1710672185067600");
		cellExample = rowExample.createCell(1);
		cellExample.setCellValue("http://bgrp.biz/b/I5BY2CYQ");
		rowExample = sheet.createRow(2);
		cellExample = rowExample.createCell(0);
		cellExample.setCellValue("1713354371866960");
		cellExample = rowExample.createCell(1);
		cellExample.setCellValue("http://bgrp.biz/b/M9F26X62");
