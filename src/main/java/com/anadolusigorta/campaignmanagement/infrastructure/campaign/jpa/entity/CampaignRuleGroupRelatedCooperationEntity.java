...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "campaign_rule_group_related_cooperation")
public class CampaignRuleGroupRelatedCooperationEntity extends AbstractEntity {
	...
	@OneToMany(mappedBy = "relatedCooperation",cascade = CascadeType.ALL,fetch = FetchType.EAGER)
