...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "campaign_rule_group_owner_product")
public class CampaignRuleGroupOwnerProductEntity extends AbstractEntity {
	...
	@OneToMany(mappedBy = "ownerProduct",cascade = CascadeType.ALL,fetch = FetchType.EAGER)
